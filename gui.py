...
class CinemaGUI:
    ...
    def force_refresh_seat_data(self):
    ...
    def display_seat_selection(self, movie):
    ...
    def show_movies_page(self):
        ...
        if st.session_state.current_movie_selection:
            ...
            if selected_movie:
                self.display_seat_selection(selected_movie)
                return
